...
const ConsolidationForm = () => {
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, `CR_${nom_departement}_${mois}_${annee}`);
    XLSX.writeFile(workbook, `Consolidation_${nom_departement}_${mois}_${annee}.xlsx`);
  };
